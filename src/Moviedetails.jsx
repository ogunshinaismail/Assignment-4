            ...
            {data && (
                <div className="movie-details">
                    ...
                    <div className="details">
                        ...
                        <p className="date">RELEASE DATE - <span>{data.release_date}</span></p>
                        <h3 className="genre-t">Genres</h3>
                        <p className="genre">{data && data.genres.map( gen => <li key={gen.id}>{gen.name}</li>)}</p>
